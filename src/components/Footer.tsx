        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/shop/collections" className="text-gray-600 hover:text-black transition-colors">Collections</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form className="flex">
              <input 
                ...
                className="px-4 py-2 w-full rounded-l-md border-gray-300 focus:ring-black focus:border-black"
              />
              <button 
                type="submit" 
